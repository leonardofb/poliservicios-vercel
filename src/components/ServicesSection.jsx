...
¿Qué hacemos?.</span></h6>
                            ...
                            <div className="w3l-button mt-lg-5 mt-4">
                                <a href="services.html" className="btn btn-style btn-primary mt-2">Leer Más <span className="fas fa-angle-double-right ms-2"></span></a>
                            </div>
                        </div>
                            ...
                            <div className="cwp23-text-cols">
                                {['g2.jpg', 'g3.jpg', 'g4.jpg', 'g5.jpg'].map((img, index) => (
                                    <div className="column" key={index}>
                                        <a href="#"><img src={`/images/${img}`} alt="" className="radius-image img-fluid" /></a>
                                    </div>
                                ))}
                            </div>
                        </div>
